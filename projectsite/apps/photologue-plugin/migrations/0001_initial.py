...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('photologue-plugin', ['GalleryPlugin'])

        # Adding model 'ImagePlugin'
        db.create_table('cmsplugin_imageplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('photologue-plugin', ['ImagePlugin'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ImagePlugin'
        db.delete_table('cmsplugin_imageplugin')
    ...
    models = {
        ...
        'photologue-plugin.galleryplugin': {
        ...
        'photologue-plugin.imageplugin': {
            'Meta': {'object_name': 'ImagePlugin', 'db_table': "'cmsplugin_imageplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['photologue.Photo']"}),
    ...
    complete_apps = ['photologue-plugin']